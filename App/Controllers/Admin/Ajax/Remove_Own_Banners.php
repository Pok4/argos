...
class Remove_Own_Banners extends \App\Controllers\BaseController {
  ...
  public function __construct() {
    ...
    $this->model = new \App\Models\Admin\Ajax\Remove_Own_Banners_Model; 
 
  }
    
  public function Remove_Own_Banners() {
