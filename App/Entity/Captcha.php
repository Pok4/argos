 ...
 * TOPIC: http://www.codexworld.com/simple-php-captcha-using-codexworldcaptcha/
...
In html form:
<img src="{{base_url}}/captcha" class="img-responsive" id="capImage"/><br/>
<a href="javascript:void(0);" onclick="javascript:$('#capImage').attr('src','{{base_url}}/captcha');">[refresh]</a>
...
if(isset($_POST['submit'])) {
  ...
  if($enteredcaptchaCode === $captchaCode){
    echo 'Entered captcha code has matched.';
  }else{
    echo 'Captcha code not matched, please try again.';
  }
}
...
class Captcha
{
    ...
    var $expiration = 7200;
    var $bg_color = '#ffffff';
    var $border_color = '#272727';
    var $text_color = '#272727';
    var $grid_color = '#272727';
    var $shadow_color = '#272727';
